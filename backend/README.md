...
## Project Structure
    ...
    ├── testapiautosetting_127060  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127060`
...
2. Clone this repo and `cd testapiautosetting_127060`
